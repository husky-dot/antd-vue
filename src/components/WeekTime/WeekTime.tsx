...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      const { colspan } = props;
      return (
        <div class="tqu-ant-weektime">
          <div class="tqu-ant-weektime-schedue"></div>
          <div
            class={{
              'tqu-ant-weektime-schedue': true,
              'tqu-ant-weektime-schedue-notransi': mode.value,
            }}
            style={styleRef.value}
          ></div>
          <table
            class={{
              'tqu-ant-weektime-table': true,
              'tqu-ant-weektime-min-table': colspan < 2,
            }}
          >
            <thead class="tqu-ant-weektime-table-head">
              <tr>
            ...
            <tbody class="tqu-ant-weektime-table-body">
              ...
              <tr>
                <td colspan={49} class="tqu-ant-weektime-table-preview">
